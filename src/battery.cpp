...
namespace Battery{
    ...
    static constexpr int MIN_SAMPLE_PERIOD_MS = 10; // 10 ms minimum between samples.
    ...
    bool setupComplete() {return initialized;}
    ...
    void update() {
        ...
        if (battSample < MIN_SAMPLE_PERIOD_MS){return;}

        battSample -= MIN_SAMPLE_PERIOD_MS;
